...
ent-LustClothingEyesSyndieSmartNVG = дешёвые солнцезащитные очки
    .desc = Пара чёрных солнцезащитных очков. Не то что бы блокируют свет, скорее аксессуар, чем что-то полезное.
