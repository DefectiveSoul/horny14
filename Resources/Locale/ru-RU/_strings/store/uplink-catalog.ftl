...
uplink-clothing-eyes-syndicate-smartnvg-name = ПНВ очки
uplink-clothing-eyes-syndicate-smartnvg-desc = Это как полноценное ПНВ, но заместо полноценных трубок это обычные очки с усилителем цвета через камеру.
